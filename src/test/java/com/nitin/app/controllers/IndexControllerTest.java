...
public class IndexControllerTest {
    ...
    @Test
    public void testMockMvcIndexControler() throws Exception {
    ...
    public void retriveHomePage() {
        ...
        when(recipeService.findAllRecipe()).thenReturn(recipes);

        ArgumentCaptor<Set<Recipe>> argumentCaptor = ArgumentCaptor.forClass(Set.class);

        String viewName = controller.retriveHomePage(model);
